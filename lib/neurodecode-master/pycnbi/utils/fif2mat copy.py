...
import scipy.io
# import pycnbi
#lib\neurodecode-master\pycnbi\utils\q_common.py
import pycnbi.utils.q_common as qc
# import lib.neurodecode-master.pycnbi.utils.q_common as qc #SyntaxError: invalid syntax
...
if __name__ == '__main__':
    # path to fif file(s)
    input_path = r'E:\\OpenMIIR-RawEEG_v1\\OpenMIIR\\eeg\\mne'
    fif2mat(input_path)
